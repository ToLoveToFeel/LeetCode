package _0000_classicalProblems._graph.shortestpath;
...
public class Floyed {
    ...
    static public void main(String[] args) {
        String graphPath = "./src/_0000_classicalProblems/_graph/shortestpath";
        ...
        WeightedGraph g2 = new WeightedGraph(graphPath + "/g2.txt");
