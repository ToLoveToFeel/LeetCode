package _0000_study._db._redis.util;

import _0000_study._db._redis.basic.ConnectionTest;
...
public class RedisUtils {
    // 配置文件路径
    public static final String PORPERTYPATH = "_0000_study\\_db\\_redis\\util\\";
