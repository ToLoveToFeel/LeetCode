 ...
 * 时间复杂度：O(n*C)
 * 空间复杂度：O(C)
 * 和 Knapsack01_dp3 相比，取消了开始的初始化，则 i 要改为从 0 开始遍历
 */
public class Knapsack01_dp4 {
    ...
    public int knapsack01(int[] weights, int[] values, int C) {
        ...
        for (int i = 0; i < n; i++) {  // 从第1个物品开始，不可以重复（物品下标从0开始）
    ...
    public static void main(String[] args) {
        ...
        System.out.println("物品的总价值最大为：" +
                (new Knapsack01_dp4()).knapsack01(weights, values, weightCapacity));
    }
}
