...
//        System.out.println((new Solution2()).maxProbability(3, edges, succProb, 0, 2));  // 0.25

//        int[][] edges = {{0, 1}, {1, 2}, {0, 2}};
//        double[] succProb = {0.5, 0.5, 0.3};
//        System.out.println((new Solution2()).maxProbability(3, edges, succProb, 0, 2));  // 0.3

        int[][] edges = {{0, 1}};
        double[] succProb = {0.5};
        System.out.println((new Solution2()).maxProbability(3, edges, succProb, 0, 2));  // 0.0
    }
}
